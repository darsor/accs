...
int main() {
    ...
    printf("\nTEST 8: Reading 12-bit values from channel 1. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 9: Reading 14_bit values from channel 1. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 10: Reading 16_bit values from channel 1. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 11: Reading 18_bit values from channel 1. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("TEST 12: Reading 12-bit values from channel 2. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 13: Reading 14_bit values from channel 2. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 14: Reading 16_bit values from channel 2. Press enter to continue... ");
    getchar();
    printf("\n");
    ...
    printf("\nTEST 15: Reading 18_bit values from channel 2. Press enter to continue... ");
    getchar();
    printf("\n");
